...
cp /root/repo_temp/templates/docker-compose.yml /home/neo4j_admin/neo4j_instance/docker-compose.yml
cp /root/repo_temp/templates/neo4j.conf /home/neo4j_admin/neo4j_instance/conf/neo4j.conf
chown neo4j_admin:neo4j_admin \
