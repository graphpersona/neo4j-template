...
sudo -u neo4j_admin cp ~/repo_temp/templates/docker-compose.yml /home/neo4j_admin/neo4j_instance/
sudo -u neo4j_admin cp ~/repo_temp/templates/neo4j.conf /home/neo4j_admin/neo4j_instance/conf/
